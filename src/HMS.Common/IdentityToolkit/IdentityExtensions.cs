...
namespace HMS.Common.IdentityToolkit
{
    /// <summary>
    /// More info: http://www.YaZahra.YaAli/post/2580
    /// And http://www.YaZahra.YaAli/post/2579
    /// </summary>
    public static class IdentityExtensions
    {
        ...
        public static string GetUserStructure(this IIdentity identity)
        {
            return identity?.GetUserClaimValue(ClaimTypes.PostalCode);
        }
    }
}