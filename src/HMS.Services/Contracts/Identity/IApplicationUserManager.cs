...
namespace HMS.Services.Contracts.Identity
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// <summary>
        /// Normalize a key (user name, email) for consistent compariHMSs.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="PasswordVerificationResult"/> indicating the result of a password hash compariHMS.
        /// </summary>
